...
def calculate_dwell_time(df):
    ...
    df_test3.columns = ['FRET_state', 'Time', 'Molecule']
...
def generate_transitions(df):
    ...
    compiled_final = compiled_df[['Molecule', 'FRET_state', 'FRET_after', 'Time']]
    compiled_final.columns = ['Molecule', 'FRET_before', 'FRET_after', 'Time']
